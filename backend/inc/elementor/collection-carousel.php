						...
						<div>
							...
							if( $show_meta ){
								$slide_html .= '<div class="collection-card__info">
									<div class="floor">
										<p>'. esc_html__("Floor",WP_SMART_NFT) .'</p>
										<p class="collection-card__info__value">
											<span>
												<img class="collection-card__info__logo" src='. $collection['currencyIcon'] .' />
												'. $collection['floor_price'] .'
											</span>
										</p>
									</div>
									<div class="total">
										<p>'. esc_html__("Volume",WP_SMART_NFT) .'</p>
										<p class="collection-card__info__value">
											<span>
												<img class="collection-card__info__logo" src='. $collection['currencyIcon'] .' />
												'. $collection['total_vol'] .'
											</span>
										</p>
									</div>
									<div class="items">
										<p>'. esc_html__("Owners",WP_SMART_NFT) .'</p>
					...
					<div class="collection-grid-classic">';
							...
							$slide_html .= '<div class="info">
								...
								if($show_meta_classic){
									$slide_html .= '<p>'. esc_html__("Floor: ",WP_SMART_NFT) . $collection['floor_price'] .' '. $collection['currencySymbol'] .'</p>';
								}
							$slide_html .= '</div>
					</div>
				</a>';
