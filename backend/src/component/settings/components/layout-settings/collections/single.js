...
export const SingleCollection = () =>{
    ...
    const defaultState = state.collections.single
    const changeState = (property, value) =>{
        const temp = {};
        temp[property] = value;
        const newState = { ...defaultState, ...temp }
        dispatch({ type: "CHANGE_COLLECTIONS_SINGLE", payload: newState })
    }

    return(
        <>
            <h2 className="settings-page__list-settings__section-heading">{__("Single Collection page", SLUG)}</h2>
            <div className="settings-page__list-settings-single">
                <div className="settings-page__list-settings-single__headings">
                    ...
                    <p>
                    {__(
                        "Select number of columns to show NFTs on collection page",
                        SLUG
                    )}
                    </p>
                </div>
            ...
            <div className="settings-page__list-settings-single">
                <div className="settings-page__list-settings-single__headings">
                    ...
                    <p>{__("Single Collection page width", SLUG)}</p>
                </div>
                <div className="settings-page__list-settings-single__controls">
                    <input
            ...
            <div className="settings-page__list-settings-single">
                <div className="settings-page__list-settings-single__headings">
                    ...
                    <p>{__("Show collection description", SLUG)}</p>
                </div>
                <div className="settings-page__list-settings-single__controls">
                    <Switch isOn={defaultState.desc} handleToggle={(e) => changeState("desc", e.target.checked)} id={'single-coll-desc'} />
                </div>
            </div>
            <div className="settings-page__list-settings-single">
                <div className="settings-page__list-settings-single__headings">
                    <h4>{__("Creator", SLUG)}</h4>
                    <p>{__("Show collection creator", SLUG)}</p>
                </div>
                <div className="settings-page__list-settings-single__controls">
                    <Switch isOn={defaultState.creator} handleToggle={(e) => changeState("creator", e.target.checked)} id={'single-coll-creator'} />
                </div>
            </div>
            <div className="settings-page__list-settings-single">
                <div className="settings-page__list-settings-single__headings">
                ...
                <div className="settings-page__list-settings-single__controls">
                    <Switch isOn={defaultState.links} handleToggle={(e) => changeState("links", e.target.checked)} id={'single-coll-links'} />
                </div>
            </div>
            <div className="settings-page__list-settings-single">
                <div className="settings-page__list-settings-single__headings">
                ...
                <div className="settings-page__list-settings-single__controls">
                    <Switch isOn={defaultState.search} handleToggle={(e) => changeState("search", e.target.checked)} id={'single-coll-search'} />
                </div>
            </div>
            <div className="settings-page__list-settings-single">
                <div className="settings-page__list-settings-single__headings">
                ...
                <div className="settings-page__list-settings-single__controls">
                    <Switch isOn={defaultState.filter} handleToggle={(e) => changeState("filter", e.target.checked)} id={'single-coll-filter'} />
                </div>
            </div>
            <div className="settings-page__list-settings-single">
                <div className="settings-page__list-settings-single__headings">
