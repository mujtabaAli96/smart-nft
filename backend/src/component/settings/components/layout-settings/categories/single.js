...
export const SingleCategories = () =>{
    ...
    const defaultState = state.categories.single
    const changeState = (property, value) =>{
        const temp = {};
        temp[property] = value;
        const newState = { ...defaultState, ...temp }
        dispatch({ type: "CHANGE_CATEGORIES_SINGLE", payload: newState })
    }

    return(
        <>
            <h2 className="settings-page__list-settings__section-heading">{__("Single Category page", SLUG)}</h2>
            <div className="settings-page__list-settings-single">
                <div className="settings-page__list-settings-single__headings">
                    ...
                    <p>
                    {__(
                        "Select number of columns to show NFTs on single category page",
                        SLUG
                    )}
                    </p>
                </div>
            ...
            <div className="settings-page__list-settings-single">
                <div className="settings-page__list-settings-single__headings">
                    ...
                    <p>{__("Number of NFTs per page/load", SLUG)}</p>
                </div>
                <div className="settings-page__list-settings-single__controls">
                    <input
            ...
            <div className="settings-page__list-settings-single">
                <div className="settings-page__list-settings-single__headings">
                    ...
                    <p>{__("Single Category page width", SLUG)}</p>
                </div>
                <div className="settings-page__list-settings-single__controls">
                    <input
            ...
            <div className="settings-page__list-settings-single">
                <div className="settings-page__list-settings-single__headings">
                    ...
                    <p>{__("Show Category description", SLUG)}</p>
                </div>
                <div className="settings-page__list-settings-single__controls">
                    <Switch isOn={defaultState.desc} handleToggle={(e) => changeState("desc", e.target.checked)} id={'single-cat-desc'} />
                </div>
            </div>
            <div className="settings-page__list-settings-single">
                <div className="settings-page__list-settings-single__headings">
                ...
                <div className="settings-page__list-settings-single__controls">
                    <Switch isOn={defaultState.search} handleToggle={(e) => changeState("search", e.target.checked)} id={'single-cat-search'} />
                </div>
            </div>
            <div className="settings-page__list-settings-single">
                <div className="settings-page__list-settings-single__headings">
                ...
                <div className="settings-page__list-settings-single__controls">
                    <Switch isOn={defaultState.filter} handleToggle={(e) => changeState("filter", e.target.checked)} id={'single-cat-filter'} />
                </div>
            </div>
            <div className="settings-page__list-settings-single">
                <div className="settings-page__list-settings-single__headings">
