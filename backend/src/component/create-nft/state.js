...
export const REDUCER = (state, action) => {
  ...
  if (action.type == "TOGGLE_FREE_MINTING") {
    return { ...state, isFreeMinting: action.payload };
  }
  ...
  if (action.type == "CHANGE_PRICE") {
    if (!action.payload) return { ...state, price: "", priceInWei: "" };
    return {
      ...state,
      price: action.payload,
      priceInWei: parseEther(`${action.payload}`).toString(),
    };
  }

  if (action.type == "CHANGE_AUCTION_MIN_PRICE") {
    return {
      ...state,
      auction: { ...state.auction, minPrice: action.payload },
    };
  }

  if (action.type == "CHANGE_AUCTION_STATUS") {
    return {
      ...state,
      auction: { ...state.auction, isAuctionSet: action.payload },
    };
  }

  if (action.type == "CHANGE_AUCTION_START_DATE") {
    return {
      ...state,
      auction: { ...state.auction, startDate: action.payload },
    };
  }

  if (action.type == "CHANGE_AUCTION_START_TIME") {
    return {
      ...state,
      auction: { ...state.auction, startTime: action.payload },
    };
  }

  if (action.type == "CHANGE_AUCTION_END_DATE") {
    return {
      ...state,
      auction: { ...state.auction, endDate: action.payload },
    };
  }

  if (action.type == "CHANGE_AUCTION_END_TIME") {
    return {
      ...state,
      auction: { ...state.auction, endTime: action.payload },
    };
  }

  if (action.type == "SET_CUSTOM_COIN") {
    return { ...state, customCoin: action.payload };
  }

  if (action.type == "CHANGE_SPLIT_PAYMENT") {
    return { ...state, splitPayments: action.payload };
  }

  if (action.type == "CHANGE_ROYALTY") {
    return { ...state, royalty: action.payload };
  }

  if (action.type == "CHANGE_HAS_SPLIT_PAYMENT") {
    return { ...state, hasSplitPayment: action.payload };
  }

  if (action.type == "CHANGE_UNLOCKABLE_CONTENT") {
    return { ...state, unlockableContent: action.payload };
  }

  if (action.type == "CHANGE_UNLOCKABLE_FILES") {
    return { ...state, unlockableFiles: action.payload };
  }
