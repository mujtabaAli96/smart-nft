...
import { ImageMedia, VideoMedia, AudioMedia, CloseMedia } from "./media";
const { __ } = wp.i18n;

const maxuploadsize = parseInt(SETTINGS?.nftImageSize || 12) * 1024 * 1024;
      ...
      errorMessage(
        __(
          `Please upload a file less then ${
            (parseInt(maxuploadsize) / 1024) / 1024
          }mb.`,
          SLUG
        )
      );
