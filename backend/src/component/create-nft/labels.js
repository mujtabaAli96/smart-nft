...
const Labels = () => {
  if( SETTINGS.nftpages?.create?.labels === "false" || !SETTINGS.nftpages?.create?.labels ) return null;
  ...
  const setLabels = () => {
    ...
    if (parseInt(value) > parseInt(maxValue)) {
      errorMessage(__("Value cant be greater then max value.", SLUG));
