  ...
  function smartnft_update_collection(){
        ...
        try{
            ...
            if( !empty( $collection['bannerImg'] )  && !empty( $collection['bannerMimeType'] )) {
                $banner_url = smartnft_upload_image_to_media_library( $collection['bannerImg'], 'banner', $collection["bannerMimeType"] ); //fn define in backend/utils/utils.php
            ...
            if( !empty( $collection['thumbImg'] )  && !empty( $collection['thumbMimeType'] )) {
                $banner_url = smartnft_upload_image_to_media_library( $collection['thumbImg'], 'banner', $collection["thumbMimeType"] ); //fn define in backend/utils/utils.php
    ...
    function smartnft_get_collection_by_post_id () {
		...
		try {
            ...
            $contract_address  = get_post_meta( intval($postId),'contractAddress', true);
